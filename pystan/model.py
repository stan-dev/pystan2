...
class StanModel:
    ...
    def __init__(self, file=None, charset='utf-8', model_name="anon_model",
        ...
        sundials_src_path = os.path.join(pystan_dir, 'stan', 'lib', 'stan_math', 'lib', 'sundials_3.1.0', 'src')
        cvodes_sources = [
            os.path.join(sundials_src_path, 'cvodes', 'cvodea.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodea_io.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_band.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_bandpre.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_bbdpre.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_dense.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_diag.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_direct.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_io.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_sparse.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_spbcgs.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_spgmr.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_spils.c'),
            os.path.join(sundials_src_path, 'cvodes', 'cvodes_sptfqmr.c'),
            os.path.join(sundials_src_path, 'nvec_ser', 'nvector_serial.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_band.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_dense.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_direct.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_iterative.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_math.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_nvector.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_spbcgs.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_spgmr.c'),
            os.path.join(sundials_src_path, 'sundials', 'sundials_sptfqmr.c'),
        ]
